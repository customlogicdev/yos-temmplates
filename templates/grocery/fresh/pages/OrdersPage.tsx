...
export function GroceryOrdersPage({ slug, store, customer, orders }: any) {
  ...
  const statusConfig: any = {
    ...
    confirmed: { label: "Confirmed", color: "#3b82f6", bg: "rgba(59,130,246,0.10)", Icon: CheckCircle2 },
    processing: { label: "Processing", color: "#8b5cf6", bg: "rgba(139,92,246,0.10)", Icon: Package },
    shipped: { label: "Shipped", color: "#06b6d4", bg: "rgba(6,182,212,0.10)", Icon: Truck },
    delivered: { label: "Delivered", color: "#10b981", bg: "rgba(16,185,129,0.10)", Icon: CheckCircle2 },
    ...
    return (
      <div className="mx-auto max-w-[900px] px-5 py-12">
        ...
        <div className="mt-10 rounded-3xl border-2 border-dashed border-green-200 bg-white py-20 text-center">
          <Package className="mx-auto h-12 w-12 text-green-400" strokeWidth={1.6} />
          <p className="mt-4 text-base font-bold text-slate-700">No orders yet</p>
