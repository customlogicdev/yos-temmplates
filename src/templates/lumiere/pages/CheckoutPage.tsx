// src/templates/beauty/lumiere/pages/CheckoutPage.tsx
...
export function LumiereCheckoutPage({ slug, store, customer }: any) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (typedRes?.success && typedRes.orderId) {
        clear();
        router.push(`${base}?page=order&order=${typedRes.orderId}`);
      } else {
